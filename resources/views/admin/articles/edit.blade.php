                                ...
                                <div class="ui grid">
                                    <div class="thirteen wide column">
                                        <div class="ui disabled fluid search selection dropdown oneShowField dropdownEpisode">
                                            <input id="inputEpisode" name="episode" type="hidden" value="@if(count($article->episodes) > 0){{ $article->episodes->first()->id }}@else{{ old('episode') }}@endif">
                                            <i class="dropdown icon"></i>
        ...
        CKEDITOR.replace( 'article' ,
            {
                ...
                extraPlugins: 'spoiler,wordcount,youtube',
                wordcount: {
                    showCharCount: true,
                    showWordCount: false,
