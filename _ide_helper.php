 ...
 * Generated for Laravel 5.4.19 on 2017-04-29.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Hash {
        ...
        {
            return \App\Packages\Hashing\YourHasher::make($value, $options);
        }
        ...
        {
            return \App\Packages\Hashing\YourHasher::check($value, $hashedValue, $options);
        }
        ...
        {
            return \App\Packages\Hashing\YourHasher::needsRehash($hashedValue, $options);
        }
    ...
    class Password {
        ...
        public static function broker($name = null)
        {
            ...
            return \App\Repositories\Auth\PasswordRepositoryManager::broker($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager            
            return \App\Repositories\Auth\PasswordRepositoryManager::getDefaultDriver();
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager            
            \App\Repositories\Auth\PasswordRepositoryManager::setDefaultDriver($name);
        }
